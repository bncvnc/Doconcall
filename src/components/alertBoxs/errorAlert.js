            ...
            <View style={styles.view_modal}>
              <View style={styles.view_parent}>
                    ...
                    <View style={styles.view_icon}>
                        <Icon name="error" size={wp('10%')} color="red" />
                    </View>
        ...
        <View style={styles.view_parent}>
          <View style={styles.view_green_top}>
            <View style={styles.view_warning}>
              <Text style={styles.text_warning}>Success</Text>
            </View>
            <View style={styles.view_close}>
              <Icon name="close" size={wp('7%')} color="#ffffff" />
            </View>
          </View>
          <View style={styles.view_icon}>
            <Icon name="check-circle" size={wp('17%')} color="green" />
          </View>
          <View style={styles.view_text_bottom}>
            <Text style={styles.text_bottom}>Login Successfully</Text></View>
        </View> */}
...
const mapsStateToProps = (state) =>{
  return{
      showModal:state.ui.showError,
      responseData:state.ui.responseData
  }
}


export default connect(mapsStateToProps,mapsDispatchToProps) (AlertError);
